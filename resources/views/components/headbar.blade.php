                    ...
                    <li id="menu-item-65"
                        ...
                        <ul class="sub-menu">
                            <li id="menu-item-706"
                                ...
                                <a href="{{ route('home') }}" aria-current="page">Home Style 1</a>
                            </li>
                            <li id="menu-item-673"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-673">
                                <a href="{{ route('home') }}">Home Style 2</a>
                            </li>
                        </ul>
                    </li>
                    <li id="menu-item-26"
                    ...
                    <li id="menu-item-35"
                        ...
                        <ul class="sub-menu">
                            ...
                            <li id="menu-item-526"
                                ...
                                <a href="{{ route('single') }}">Shop Single</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="wpo-mini-cart">
                    ...
                    <div class="wpo-mini-cart-content">
                        ...
                        <div class="wpo-mini-cart-action clearfix">
                            ...
                            <a href="{{ route('shop') }}" class="view-cart-btn"> Go To Shop </a>
                        </div>
                    </div>
                </div>
