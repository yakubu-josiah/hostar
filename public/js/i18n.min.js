        ...
        function d(t) {
            var n = (function (t) {
                for (var n, e, r, i, o = [], a = []; (n = t.match(p)); ) {
                    for (
                        e = n[0],
                            (r = t.substr(0, n.index).trim()) && o.push(r);
                        (i = a.pop());
