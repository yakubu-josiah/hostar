(this.wc = this.wc || {}),
    (this.wc.wcBlocksRegistry = (function (e) {
        var t = {};
        function n(o) {
        ...
        143: function (e, t, n) {
            "use strict";
            n.r(t),
                n.d(t, "registerPaymentMethod", function () {
                    return w;
                }),
                n.d(t, "registerExpressPaymentMethod", function () {
                    return k;
                }),
                n.d(t, "registerPaymentMethodExtensionCallbacks", function () {
                    return P;
                }),
                n.d(t, "__experimentalDeRegisterPaymentMethod", function () {
                    return M;
                }),
                n.d(
                    t,
                ...
                n.d(t, "getPaymentMethods", function () {
                    return T;
                }),
                n.d(t, "getExpressPaymentMethods", function () {
                    return C;
                }),
                n.d(t, "getRegisteredBlockComponents", function () {
                    return x;
                }),
                n.d(t, "getRegisteredInnerBlocks", function () {
                    return I;
                }),
                n.d(t, "registerBlockComponent", function () {
                    return S;
                }),
                n.d(t, "registerInnerBlock", function () {
                    return _;
                });
            var o = n(8),
                r = n.n(o),
            ...
            const l = {},
                    ...
                    const o = (
                        (e, t) => (n) =>
                            (
                                ...
                                []
                            ).every((e) => t.includes(e)) && e(n)
                    )(e, t);
                    return Object.values(u).some((e) => n in e)
                        ? ((e, t, n) => (o) => {
                              let r = e(o);
                              if (r) {
                                  const e = {};
                                  Object.entries(t).forEach((t) => {
                                      ...
                                      (r = Object.keys(e).every((t) => {
                                          try {
                                              ...
                                              return (
                                                  console.error(
                                                      `Error when executing callback for ${n} in ${t}`,
                                                      e
                                                  ),
                                                  !0
                                              );
                ...
                d = (e, t) => {
                    if (null !== e && !Object(c.isValidElement)(e))
                        throw new TypeError(
                ...
                m = function (e) {
                    let t =
                        arguments.length > 1 && void 0 !== arguments[1]
                            ...
                            : [];
                    const n = t.reduce(
                        (t, n) => (e.hasOwnProperty(n) || t.push(n), t),
                        []
                    );
                    if (n.length > 0)
                        throw new TypeError(
            ...
            s()(f, "assertValidConfig", (e) => {
                var t, n, o, a, i, s, l;
                if (
                    ((e.savedTokenComponent =
                        e.savedTokenComponent ||
                        Object(c.createElement)(h, null)),
                    m(e, [
                        "name",
                        "label",
                        "ariaLabel",
                ...
                if (
                    ...
                    d(e.content, "content"),
                    d(e.edit, "edit"),
                    d(e.savedTokenComponent, "savedTokenComponent"),
                ...
                if (
                    void 0 !==
                        (null === (t = e.supports) || void 0 === t
                            ...
                            : t.showSavedCards) &&
                    "boolean" !=
                        typeof (null === (n = e.supports) || void 0 === n
                            ? void 0
                            : n.showSavedCards)
                )
                    throw new TypeError(
            ...
            s()(y, "assertValidConfig", (e) => {
                var t, n;
                if (
                    (m(e, ["name", "content", "edit"]),
                    "string" != typeof e.name)
                )
                    throw new TypeError(
            ...
            const g = {},
                ...
                w = (e) => {
                    ...
                    "function" == typeof e
                        ? ((t = e(f)),
                          r()("Passing a callback to registerPaymentMethod()", {
                ...
                k = (e) => {
                    ...
                    "function" == typeof e
                        ? ((t = e(y)),
                          r()(
                              "Passing a callback to registerExpressPaymentMethod()",
                              {
                                  alternative: "a config options object",
                                  plugin: "woocommerce-gutenberg-products-block",
                                  link: "https://github.com/woocommerce/woocommerce-gutenberg-products-block/pull/3404",
                        ...
                        : ((l[e] = {}),
                          Object.entries(t).forEach((t) => {
                              ...
                              "function" == typeof o
                                  ? (l[e][n] = o)
                                  : console.error(
                                        `All callbacks provided to registerPaymentMethodExtensionCallbacks must be functions. The callback for the ${n} payment method in the ${e} namespace was not a function.`
                                    );
                          }));
                },
                M = (e) => {
                    delete g[e];
                    const { __internalRemoveAvailablePaymentMethod: t } =
                        Object(a.dispatch)(b.b);
                    t(e);
                },
                E = (e) => {
                    delete v[e];
                    const { __internalRemoveAvailableExpressPaymentMethod: t } =
                        Object(a.dispatch)(b.b);
                    t(e);
                },
                T = () => g,
            ...
            function x(e) {
                return {
                    ...("object" == typeof O[e] && Object.keys(O[e]).length > 0
                        ? O[e]
                        : {}),
                    ...O.any,
                };
            ...
            function S(e) {
                e.context || (e.context = "any"),
                    R(e, "context", "string"),
                    R(e, "blockName", "string"),
                    j(e, "component");
                const { context: t, blockName: n, component: o } = e;
                O[t] || (O[t] = {}), (O[t][n] = o);
            }
            const j = (e, t) => {
                    if (e[t]) {
                        ...
                        if (
                            e[t].$$typeof &&
                            e[t].$$typeof === Symbol.for("react.lazy")
                        )
                            return;
                    }
                    throw new Error(
                ...
                R = (e, t, n) => {
                    ...
                    if (o !== n)
                        throw new Error(
                            `Incorrect value for the ${t} argument when registering a block component. It was a ${o}, but must be a ${n}.`
                        );
                };
            function _(e) {
